...
<div id="slider-wrap">
		...
		<ul class="slides">
			...
			<?php $my_query = new WP_Query( 'cat= '. $slider_cat_id .'&showposts='.$slide_count.'' );
				...
				<li>
					<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img src="<?php echo get_post_meta( $post->ID, 'slide', $single = true ); ?>" /></a>
					
					<div class="flex-caption">
						<h2 class="flex-title"><a title="<?php the_title(); ?>" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
						<p><?php truncate_post( 110, true ); ?></p>
						<a class="slider-more" href="<?php the_permalink(); ?>"></a>
					</div>
				</li>
